...
##Data Cleaning
```{r}
MindfulnessDat<- read.csv("C:/Users/kaile/Downloads/MindfulnessData_fullunmatched_raw_items_NadlerCarswellMinda.csv", header=FALSE)

NadlerDat<- read.csv("C:/Users/kaile/Downloads/MindfulnessDataExport_NadlerCarswellMinda2020.csv", header=FALSE, dec=",")
