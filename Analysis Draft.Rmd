...
```{r}
ggplot(MindfulnessDatParticipant, aes(FacetQuestMean, Competency)) + geom_point() + geom_smooth(method = "lm") + xlab("Mindfulness") + ylab("Competency") +ggtitle("Correlation between Mindfullness and Competency Measure 1")
```
...
```{r}
ggplot(MindfulnessDatParticipant, aes(FacetQuestMean, Competency2)) + geom_point() + geom_smooth(method = "lm") + xlab("Mindfulness") + ylab("Competency") +ggtitle("Correlation between Mindfullness and Competency Measure 2")
```
