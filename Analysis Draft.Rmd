...
```{r}
#running a correlational analysis between well being and competency ratings.
...
cor(MindfulnessDatParticipant$Competency, MindfulnessDatParticipant$FacetQuestMean)

library(ggplot2)
ggplot(MindfulnessDatParticipant, aes(FacetQuestMean, Competency)) + geom_point() + geom_smooth(method = "lm")


MindfulnessDatParticipant$Competency2 <- NA

for(i in 1:nrow(MindfulnessDatParticipant)){  
  MindfulnessDatParticipant$Competency[i] <- ((MindfulnessDatParticipant$Brief.Resilience.Scale[i] +MindfulnessDatParticipant$Brief.Resilience.Scale.1[i] +MindfulnessDatParticipant$Brief.Resilience.Scale.2[i]                                      +MindfulnessDatParticipant$Brief.Resilience.Scale.3[i] +MindfulnessDatParticipant$Brief.Resilience.Scale.4[i] +MindfulnessDatParticipant$Brief.Resilience.Scale.5[i])/6)}


cor(MindfulnessDatParticipant$Competency2, MindfulnessDatParticipant$FacetQuestMean)

library(ggplot2)
ggplot(MindfulnessDatParticipant, aes(FacetQuestMean, Competency2)) + geom_point() + geom_smooth(method = "lm")



#R^2 will use cor("y actual", "y predict")^2, but the variables used for y predict are being finalized
```
